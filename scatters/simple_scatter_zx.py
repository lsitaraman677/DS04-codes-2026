...
iters = ts.iterations
y, z = ts.get_particle(species = "beam1", var_list = ["x", "z"], iteration = 400)
y2, z2 = ts.get_particle(species = "beam2", var_list = ["x", "z"], iteration = 400)
y3, z3 = ts.get_particle(species = "pho1", var_list = ["x", "z"], iteration = 400)
y4, z4 = ts.get_particle(species = "pho2", var_list = ["x", "z"], iteration = 400)
...
for it in iters:
    y, z = ts.get_particle(species = "beam1", var_list = ["x", "z"], iteration = it)
    y2, z2 = ts.get_particle(species = "beam2", var_list = ["x", "z"], iteration = it)
    y3, z3 = ts.get_particle(species = "pho1", var_list = ["x", "z"], iteration = it)
    y4, z4 = ts.get_particle(species = "pho2", var_list = ["x", "z"], iteration = it)
    y3 = np.append(np.array(y3), np.array(y4))
    z3 = np.append(np.array(z3), np.array(z4))
